...
/**
 * Accounting-service RabbitMQ config.
 * Imports shared topology — accountingQueue already bound to loan.#, payment.#, float.#, account.#
 * Just adds a listener container factory with Jackson converter.
 */
@Configuration
