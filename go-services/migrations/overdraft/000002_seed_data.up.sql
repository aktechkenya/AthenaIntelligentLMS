...
-- Ensure unique index for idempotent seeding
CREATE UNIQUE INDEX IF NOT EXISTS uq_band_config_tenant_band ON credit_band_configs(tenant_id, band);

-- Seed default band configs (system-level)
-- Rates are stored as decimals: 0.15 = 15% p.a.
