...
@OpenAPIDefinition(
    info = @Info(
        ...
        version = "v1",
        description = "Athena LMS — Real-time fraud detection, AML monitoring, rule engine, risk scoring. Authenticate using a JWT Bearer token obtained from the Account Service login endpoint.",
